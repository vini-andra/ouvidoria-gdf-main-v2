...
import { UserX, User, Mail, AlertTriangle, LogIn, Shield, HelpCircle } from "lucide-react";
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                aria-label="Ajuda sobre identificação"
              >
                <HelpCircle className="h-4 w-4" />
              </button>
            </TooltipTrigger>
            <TooltipContent className="max-w-sm">
              <p className="font-semibold mb-2">Quando escolher cada opção?</p>
              <ul className="space-y-1 text-sm">
                <li>✅ <strong>Anônimo:</strong> Denúncias sensíveis, proteção de identidade</li>
                <li>✅ <strong>Identificado:</strong> Receba acompanhamento por email, resposta direta</li>
              </ul>
            </TooltipContent>
          </Tooltip>
        </div>
